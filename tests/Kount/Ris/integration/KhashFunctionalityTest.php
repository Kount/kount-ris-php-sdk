...
class KhashFunctionalityTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $configKey = (new UtilityHelperTest())->getArraySettings()->getConfigKey();
        Kount_Util_Khash::setConfigKey($configKey);
